...
Write-Host '*** WVD AIB CUSTOMIZER PHASE *** Set default Language ***'
...
Write-Host '*** WVD AIB CUSTOMIZER PHASE *** Set default language *** - Exit Code: '$LASTEXITCODE
